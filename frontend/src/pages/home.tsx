  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={homeBack}
          alt={t("Tecnologia premium en Puntotech")}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-20">
        <div className="max-w-2xl">
          ...
          >
            {t("Tu proximo")}
            <br />
            <span className="gradient-text">{t("nivel tech")}</span>
            <br />
            {t("empieza aqui")}
          </motion.h1>
          ...
          >
            {t("Celulares, computadores, audio y accesorios con recomendaciones inteligentes, combos exclusivos y garantia extendida digital.")}
          </motion.p>
          ...
          >
            {[
              { value: "500+", label: t("Productos") },
              { value: "24h", label: t("Envio rapido") },
              { value: "2 anos", label: t("Garantia digital") },
            ].map((stat) => (
              <div key={stat.label}>
